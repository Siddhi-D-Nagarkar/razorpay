...
public class UpiPaymentStrategy implements PaymentStrategy {
    ...
    public PaymentResult initiate(PaymentRequest request) {
        ...
        try {
            ...
            log.warn("Exception occurred while initiating Upi payment for request with paymentId : {}. Exception : {}",
                    request.paymentId(), e.getMessage());
            return new PaymentResult.Failure("UPI_FAILED", "An internal error occurred while processing the payment.");
        }
    }
